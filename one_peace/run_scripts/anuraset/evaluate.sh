...
export MASTER_PORT=6082  # Changed port to avoid conflict
export CUDA_VISIBLE_DEVICES=1,2,3
export GPUS_PER_NODE=3

config_dir=../../run_scripts
path=../../checkpoints/finetune_anuraset.pt
task_name=anuraset
model_name=one_peace_classify
selected_cols=uniq_id,audio,text,duration
results_path=../../results/anuraset

data=../../dataset/anuraset/anuraset_test.tsv
gen_subset='test'
