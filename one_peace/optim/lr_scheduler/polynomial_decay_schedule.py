...
@dataclass
class AdjustPolynomialDecayLRScheduleConfig(FairseqDataclass):
...
@register_lr_scheduler("adjust_polynomial_decay", dataclass=AdjustPolynomialDecayLRScheduleConfig)
class Adjust_PolynomialDecayLRSchedule(FairseqLRScheduler):
    """Decay the LR on a fixed schedule."""

    def __init__(self, cfg: AdjustPolynomialDecayLRScheduleConfig, optimizer):
