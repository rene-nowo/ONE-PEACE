...
import mmcv
import mmaction_custom   # noqa: F401,F403
import torch
...
def main():
    ...
    for name, param in model.named_parameters():
        if 'temporal_embedding' not in name and 'image_layer_norm' not in name and 'cls_head' not in name and 'Adapter' not in name:
